#!/usr/bin/env python3
"""Synthesize all 2024 walk-forward simulation results into a comprehensive report."""
import json, os, glob
from collections import defaultdict, Counter

RESULTS_DIR = "/Users/huaichuaibeimeng/claude-projects/sim-portfolio/research-notes/astock-backtest/2024/sim-results"

def main():
    files = sorted(glob.glob(os.path.join(RESULTS_DIR, "sim-2024-*.json")))
    ...
    print("=" * 70)
    print("2024年A股Walk-Forward回测全年汇总")
    print("=" * 70)
    print(f"\n总选股次数: {total}")
    ...
    out = os.path.join(RESULTS_DIR, "synthesis-2024.json")
