...
5. **分级制: A级≤25%, B级≤15%, C级≤8%, T级≤8%，A股单板块≤40%, 美股单板块≤35%, 现金≥20%** — 超限必须先处理再做其他操作
...
标的 / 方向(多/空) / thesis(一句话) / 催化剂+日期（必须30天内，A级例外）/ 入场价 / 止损价(downside%) / 目标价(upside%) / R/R比 / 信心等级(A/B/C) / 对应仓位上限(A≤25%/B≤15%/C≤8%) / Bear case downside% / Timing理由
