...
- 思源电气: `002028.SZ`, 蓝思科技: `300433.SZ`, 晶方科技: `603005.SS`
- SPUT实际交易代码: `SRUUF`（OTC，买卖价差较宽，注意流动性）
- 美股其他ticker直接用: NVDA, HSAI, AAPL, GOOGL, ADBE, GEV, LEU
...
| 日期 | 标的 | 事件 | 预案 |
|------|------|------|------|
| 2026-05-19 | HSAI | Q1财报 BMO盘前 | Beat→加仓至10%; In-line→守仓1周; Miss→守$20 backstop |
| 2026-05-28 | NVDA | Q1 FY2027财报 AMC盘后 | Beat→维持12%不追(共识满); Miss→评估降至8%; A股05-29映射晶方/蓝思 |
| 2026-06-08 | AAPL | WWDC 2026 | 超预期→加仓至15%追25股; 延期→维持10% |
| 2026-06-11 | ADBE | Q2 FY2026财报 AMC盘后 | FCF>38%+加速→加仓至12%; AI威胁加剧→评估减至5% |
