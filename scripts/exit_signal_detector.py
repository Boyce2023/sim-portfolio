...
SECTOR_LEADERS: dict[str, list[tuple[str, str]]] = {
    ...
    "医药": [("600276", "恒瑞医药"), ("603259", "药明康德"), ("300760", "迈瑞医疗")],
    "新能源车": [("002594", "比亚迪"), ("300750", "宁德时代")],
    "军工": [("600760", "中航沈飞"), ("600893", "航发动力"), ("002179", "中航光电")],
    "券商": [("600030", "中信证券"), ("300059", "东方财富"), ("601995", "中金公司")],
    "银行": [("600036", "招商银行"), ("002142", "宁波银行"), ("601166", "兴业银行")],
    "白酒": [("600519", "贵州茅台"), ("000858", "五粮液"), ("000568", "泸州老窖")],
    "地产": [("600048", "保利发展"), ("000002", "万科A"), ("001979", "招商蛇口")],
    "光伏": [("601012", "隆基绿能"), ("600438", "通威股份")],
    "稀土": [("600111", "北方稀土"), ("000831", "中国稀土")],
    "储能": [("300274", "阳光电源"), ("688063", "派能科技")],
    "锂电": [("002466", "天齐锂业"), ("002460", "赣锋锂业")],
}
